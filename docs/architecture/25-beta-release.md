...
`dist/Pulse-Setup-0.1.2-beta-windows-x64.exe` (Inno Setup)
...
| Output | Role |
|--------|------|
| `dist/Pulse-Setup-0.1.2-beta-windows-x64.exe` | **End-user installer** |
| `dist/Pulse/` | Payload used by Inno |
| `dist/Pulse-0.1.2-beta-windows-x64.zip` | Optional payload archive |
