...
Produces `dist\Pulse-Setup-0.2.0-beta-windows-x64.exe`, `dist\Pulse\`, and `dist\Pulse-0.2.0-beta-windows-x64.zip`. See [docs/architecture/25-beta-release.md](docs/architecture/25-beta-release.md).
