...
Produces `dist\Pulse-Setup-0.1.3-beta-windows-x64.exe`, `dist\Pulse\`, and `dist\Pulse-0.1.3-beta-windows-x64.zip`. See [docs/architecture/25-beta-release.md](docs/architecture/25-beta-release.md).
