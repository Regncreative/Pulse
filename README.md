...
1. Download **`Pulse-Setup-0.2.1-beta-windows-x64.exe`** from [GitHub Releases](https://github.com/Regncreative/Pulse/releases)
...
Output: `dist\Pulse-Setup-0.2.1-beta-windows-x64.exe`, `dist\Pulse\`, and `dist\Pulse-0.2.1-beta-windows-x64.zip`
