...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-v0.1.0--bootstrap-orange?style=flat-square" />
...
1. Download **`Pulse-Setup-0.2.0-beta-windows-x64.exe`** from [GitHub Releases](https://github.com/Regncreative/Pulse/releases)
...
Output: `dist\Pulse-Setup-0.2.0-beta-windows-x64.exe`, `dist\Pulse\`, and `dist\Pulse-0.2.0-beta-windows-x64.zip`
